...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/movyzebk", {
        method: "POST",
    ...
    <div className="bg-black text-white">
      ...
      >
        <nav className="flex flex-col gap-6" aria-label="Page sections">
          {["intro", "about", "stack", "projects", "work", "contact"].map(
            (section, index) => (
              <motion.a
                key={section}
                href={`#${section}`}
      ...
      <main id="main-content" className="relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-12 md:py-16 lg:py-20 relative z-10">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
              ...
              <div className="space-y-6 md:space-y-8 lg:pt-20">
                ...
                >
                  I build web applications that solve real business problems by
                  understanding both the technical architecture and the people
                  who use them. My background in hardware repair and interest in
                  human behavior helps me create solutions that are genuinely
                  useful, not just technically sound.
                </motion.p>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 sm:p-6 space-y-1 sm:space-y-2 text-xs sm:text-sm overflow-x-auto">
                    ...
                    >
                      ...
                      , <span className="text-green-300">&apos;AJAX&apos;</span>
                      ],
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0 }}
                    ...
                    >
                      ...
                      <span className="text-green-300">&apos;MySQLi&apos;</span>
                      ],
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0 }}
                    ...
                    <motion.div
                      ...
                      className="pl-2 sm:pl-4"
                    >
                      <span className="text-pink-400">apis</span>: [
                      <span className="text-green-300">&apos;Twilio&apos;</span>
                      ,{" "}
                      <span className="text-green-300">
                        &apos;Leaflet&apos;
                      </span>
                      ...
                      ,{" "}
                      <span className="text-green-300">&apos;TCPDF&apos;</span>
                      ],
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0 }}
                    ...
                    >
                      ...
                      ,{" "}
                      <span className="text-green-300">&apos;Apache&apos;</span>
                      ]
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0 }}
        ...
        <section
          id="about"
          className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-b from-black via-gray-950 to-black relative overflow-hidden"
        >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-gray-400 leading-relaxed text-justify">
                      ...
                      . This unique combination gives me a deeper understanding
                      of how systems work—not just in code, but in the real
                      world where things can break, users get frustrated, and
                      solutions need to be both technically sound and
                      practically useful.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-gray-400 leading-relaxed text-justify">
                      ...
                      . This interest shapes how I approach development—I
                      don&apos;t just ask &quot;how do I build this?&quot; but
                      also{" "}
                      <span className="text-white font-medium">
                        &quot;why does it matter?&quot;
                      </span>{" "}
                      ...
                      Great software isn&apos;t just about elegant code;
                      it&apos;s about understanding the people who use it.
                    </p>
                  </motion.div>
                </div>
              </FadeInSection>
                ...
                >
                  ...
                  <div className="pl-4 sm:pl-6 text-center">
                    ...
                    <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-300 leading-relaxed text-center">
                      <p>
                        I believe great development isn&apos;t just about
                        writing code—it&apos;s about{" "}
                        <span className="text-white font-medium">
                          understanding both the technical architecture and the
                          human needs
                        </span>{" "}
                        behind every project.
                      </p>
                      <p>
                        Rather than chasing the latest trends, I focus on{" "}
                        <span className="text-white font-medium">
                          mastering fundamentals
                        </span>{" "}
                        and building things the right way. I believe in depth
                        over shortcuts, in understanding the &quot;why&quot;
                        before jumping to the &quot;how.&quot;
                      </p>
                      <p>
                        Whether it&apos;s a POS system for LPG distribution or a
                        real-time monitoring dashboard, my goal is always the
                        same:{" "}
                        <span className="text-white font-medium">
                          create interconnected systems that transform complex
              ...
              <FadeInSection delay={0.3}>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  >
                    ...
                    <h4 className="font-bold text-base sm:text-lg mb-2 text-cyan-400">
                      Purpose First
                    </h4>
                    <p className="text-xs sm:text-sm text-gray-400">
                      Understanding the &quot;why&quot; and &quot;who it
                      helps&quot; before diving into implementation
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🔧</div>
                    <h4 className="font-bold text-base sm:text-lg mb-2 text-purple-400">
                      Practical Solutions
                    </h4>
                    <p className="text-xs sm:text-sm text-gray-400">
                      Building systems that work in the real world, not just in
                      theory
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🧠</div>
                    <h4 className="font-bold text-base sm:text-lg mb-2 text-pink-400">
                      Human-Centered
                    </h4>
                    <p className="text-xs sm:text-sm text-gray-400">
                      Designing with empathy for the people who will actually
                      use the system
                    </p>
                  </motion.div>
                </div>
        ...
        <section
          id="stack"
          className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-b from-black to-gray-950"
        >
        ...
        <section
          id="projects"
          className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-16 bg-black"
        >
          <div className="max-w-7xl mx-auto">
            <FadeInSection>
              <div className="mb-10 sm:mb-12 md:mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-16">
              <FadeInSection delay={0.1}>
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-cyan-400 text-center mt-3 sm:mt-4">
                    Understand
                  </h3>

                  {/* Description */}
                  <p className="text-gray-400 leading-relaxed text-xs sm:text-sm text-center">
                    Start with the business problem, not the technology. I dig
                    deep to understand what users actually need and why it
                    matters to them.
                  </p>
                </motion.div>
              </FadeInSection>
              ...
              <FadeInSection delay={0.2}>
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-purple-400 text-center mt-3 sm:mt-4">
                    Empathize
                  </h3>

                  {/* Description */}
                  <p className="text-gray-400 leading-relaxed text-xs sm:text-sm text-center">
                    Consider who will use the system and their daily challenges.
                    Design with empathy for real people, not abstract
                    &quot;users.&quot;
                  </p>
                </motion.div>
              </FadeInSection>
              ...
              <FadeInSection delay={0.3}>
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-pink-400 text-center mt-3 sm:mt-4">
                    Build
                  </h3>

                  {/* Description */}
                  <p className="text-gray-400 leading-relaxed text-xs sm:text-sm text-center">
                    Build with depth over shortcuts. Master fundamentals, write
                    clean code, and create systems that are both technically
                    sound and practical.
                  </p>
                </motion.div>
              </FadeInSection>
              ...
              <FadeInSection delay={0.4}>
                ...
                >
                  ...
                  {/* Description */}
                  <p className="text-gray-400 leading-relaxed text-xs sm:text-sm text-center">
                    Refine based on real feedback and usage. Great software
                    evolves through continuous improvement and learning.
                  </p>
                </motion.div>
              </FadeInSection>
            </div>
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    ...
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold">
                      Real Example: New Zion POS System
                    </h3>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-xs sm:text-sm">
                    <div>
                      ...
                      <p className="text-gray-400 leading-relaxed text-center">
                        LPG distribution relied on manual processes causing
                        errors and delays across two branches. The real problem
                        wasn&apos;t lack of technology—it was inefficient
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 leading-relaxed text-center">
                        Staff needed quick order processing under pressure.
                        Customers wanted transparency. Management needed
                        reliable data for decisions—not just another dashboard.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 leading-relaxed text-center">
                        Built a comprehensive POS with SMS notifications for
                        branch communication, real-time inventory tracking, and
                        customer management—all integrated seamlessly.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 leading-relaxed text-center">
                        Result: 70% faster processing, 50% fewer errors.
                        Continuous refinements based on daily operations made it
                        truly indispensable.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <FadeInSection delay={0.1}>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4 sm:mb-6 flex-grow italic mt-3 sm:mt-4 text-justify">
                    &quot;Outstanding developer with a unique ability to
                    understand both technical requirements and user needs. The
                    POS system transformed our operations completely.&quot;
                  </p>
              ...
              <FadeInSection delay={0.2}>
                ...
                >
                  ...
                  {/* Quote */}
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4 sm:mb-6 flex-grow italic mt-3 sm:mt-4 text-justify">
                    &quot;A talented developer who brings fresh perspectives to
                    problem-solving. His work on our dashboard system exceeded
                    expectations and delivered real value.&quot;
                  </p>
              ...
              <FadeInSection delay={0.3}>
                ...
                >
                  ...
                  {/* Quote */}
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4 sm:mb-6 flex-grow italic mt-3 sm:mt-4 text-justify">
                    &quot;Exceptional attention to detail and genuine care for
                    user experience. He doesn&apos;t just write code—he creates
        ...
        <section
          id="contact"
          className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-16 bg-black relative overflow-hidden"
        >
          {/* Background Elements */}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <motion.button
                    ...
                    whileHover={{
                      scale: formStatus === "submitting" ? 1 : 1.02,
                    }}
                ...
                <p className="text-sm text-gray-500 mt-6">* Required fields</p>
              </motion.form>
            </FadeInSection>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <FadeInSection>
              ...
              <div className="mt-10 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-gray-900 text-xs sm:text-sm text-gray-600 text-center lg:text-left">
                <p>
                  © {new Date().getFullYear()} — Designed & Built by Keith
                  Dwarren P. Vergara
                </p>
              </div>
            </FadeInSection>
      ...
      <div className="bg-gray-950/50 border border-gray-800 rounded-lg p-4 sm:p-6 md:p-8 backdrop-blur-sm">
        <div
          className={`grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center ${
            direction === "right" ? "lg:direction-rtl" : ""
          }`}
        >
          ...
          <div
            className={`space-y-4 sm:space-y-5 md:space-y-6 ${
              direction === "right" ? "lg:direction-ltr" : ""
            }`}
          >
            <div>
